...
- **A compact layout toggle.** The button beside the light/dark switch shrinks the
  ...
  boxes, buttons and the base-stat cards all tighten up, and both the base stats and
  the manual stat bonuses sit on a single row instead of wrapping onto two. Your
