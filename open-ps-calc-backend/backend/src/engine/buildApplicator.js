...
function applyGearBonuses(build, gearBonuses) {
  ...
  return {
    ...
    bonus_cri: build.bonus_cri + gb.cri + (gb.status_cri || 0) + (ma.cri || 0) + (cons.cri || 0),
    ...
    bonus_status_crit_atk_rate: (build.bonus_status_crit_atk_rate || 0) + (gb.status_crit_atk_rate || 0),
