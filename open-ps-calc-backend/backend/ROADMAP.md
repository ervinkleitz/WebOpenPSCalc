...
9. **Ninja [5]** — ✅ done (PS wiki, with-DEF). Confirmed correct: Huuma (200+150×lv = 350→950%),
   ...
   Kirikage (superseded 2026-09-14 by Alardun's confirmed formula: Hiding 100+200×(lv−1) = 100→900%,
   Not-Hiding 100+90×(lv−1) = 100→460%, no distance term — see PS_SOURCES.md §4; +Crit via Shadow's Within), Raigeki Sai (150+60×lv = 210→450%). **Fixed:** Bakuenryu (300→900% = 150+150×lv;
